...
set_property PACKAGE_PIN T18 	 [get_ports {up[1]}]						
set_property IOSTANDARD LVCMOS33 [get_ports {up[1]}]
set_property PACKAGE_PIN T17 	 [get_ports reset]						
set_property IOSTANDARD LVCMOS33 [get_ports reset]
set_property PACKAGE_PIN U17 	 [get_ports {down[1]}]						
set_property IOSTANDARD LVCMOS33 [get_ports {down[1]}]

set_property PACKAGE_PIN U18 	 [get_ports {up[0]}]						
set_property IOSTANDARD LVCMOS33 [get_ports {up[0]}]
set_property PACKAGE_PIN W19 	 [get_ports {down[0]}]						
